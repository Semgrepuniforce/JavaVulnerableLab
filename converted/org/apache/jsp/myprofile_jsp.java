   ...
   if(id!=null && !id.equals(""))
   {
        Statement stmt = con.createStatement();
             ...
             rs=stmt.executeQuery("select * from users where id="+id);
              if(rs != null && rs.next())
              {
                out.print("UserName : "+rs.getString("username")+"<br>");   // [JSP] myprofile.jsp:24
                out.print("Email : "+rs.getString("email")+"<br>");   // [JSP] myprofile.jsp:25
                out.print("About : "+rs.getString("about")+"<br>");   // [JSP] myprofile.jsp:26
                 
                //Getting Card Details:  // [JSP] myprofile.jsp:28
                ResultSet rs1=stmt.executeQuery("select * from cards where id="+id);  // [JSP] myprofile.jsp:29
                 if(rs1 != null && rs1.next())  // [JSP] myprofile.jsp:30
                {  // [JSP] myprofile.jsp:31
                   out.print("<br/>-------------------<br/>Card Details:<br/>-------------------<br/>");  // [JSP] myprofile.jsp:32
                   out.print("Card Number: "+rs1.getString("cardno")+"<br/>");  // [JSP] myprofile.jsp:33
                   out.print("CVV: "+rs1.getString("cvv")+"<br/>");  // [JSP] myprofile.jsp:34
                   out.print("Expiry Date: "+rs1.getString("expirydate")+"<br/>");  // [JSP] myprofile.jsp:35
                }  // [JSP] myprofile.jsp:36
                 else  // [JSP] myprofile.jsp:37
                 {  // [JSP] myprofile.jsp:38
                     out.print("<br/>No Card Details Found: <a href='changeCardDetails.jsp'>Add Card</a><br/>");  // [JSP] myprofile.jsp:39
                 }  // [JSP] myprofile.jsp:40
              }  // [JSP] myprofile.jsp:41
   }  // [JSP] myprofile.jsp:42
   else  // [JSP] myprofile.jsp:43
   {  // [JSP] myprofile.jsp:44
       out.print("ID Parameter is Missing");  // [JSP] myprofile.jsp:45
   }  // [JSP] myprofile.jsp:46
     
   out.print("<br/><ul type='square'>");  // [JSP] myprofile.jsp:48
   out.print("<li><a href='"+path+"/vulnerability/csrf/change-info.jsp'>Change Description</a></li>");  // [JSP] myprofile.jsp:49
    out.print("<li><a href='"+path+"/vulnerability/csrf/changepassword.jsp'>Change Password</a></li>");  // [JSP] myprofile.jsp:50
     out.print("<li><a href='"+path+"/vulnerability/idor/change-email.jsp'>Change Email</a></li>");  // [JSP] myprofile.jsp:51
      out.print("<li><a href='"+path+"/vulnerability/Messages.jsp'>Messages </a></li>");   // [JSP] myprofile.jsp:52
         out.print("<li><a href='"+path+"/vulnerability/SendMessage.jsp'>Send Message </a></li>");   // [JSP] myprofile.jsp:53
         out.print("</ul><br/>");  // [JSP] myprofile.jsp:54
    out.print("<br/><a href='"+path+"/vulnerability/forum.jsp'>Return to Forum &gt;&gt;</a>");       // [JSP] myprofile.jsp:55
    
}  // [JSP] myprofile.jsp:57
else  // [JSP] myprofile.jsp:58
{  // [JSP] myprofile.jsp:59
    out.print("Please login to see Your Profile");  // [JSP] myprofile.jsp:60
}  // [JSP] myprofile.jsp:61
