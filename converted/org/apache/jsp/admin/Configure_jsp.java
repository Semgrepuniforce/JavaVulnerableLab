 ...
 if(session.getAttribute("isLoggedIn")!=null)
{
    ...
    {
        Properties props=new Properties();  // [JSP] admin/Configure.jsp:18
       
        props.load(new FileInputStream(configPath));  // [JSP] admin/Configure.jsp:20
        props.setProperty("siteTitle",request.getParameter("siteTitle"));  // [JSP] admin/Configure.jsp:21
        FileOutputStream fileout = new FileOutputStream(configPath);  // [JSP] admin/Configure.jsp:22
        props.store(fileout, null);   // [JSP] admin/Configure.jsp:23
        fileout.close();  // [JSP] admin/Configure.jsp:24
        out.print("<b class='success'> Configuration saved </b>");  // [JSP] admin/Configure.jsp:25
    }  // [JSP] admin/Configure.jsp:26
  }  // [JSP] admin/Configure.jsp:27
 else  // [JSP] admin/Configure.jsp:28
 {  // [JSP] admin/Configure.jsp:29
     out.print("<b style='color:red'> x You Are not Authorized to view this Page x </b>");  // [JSP] admin/Configure.jsp:30
 }  // [JSP] admin/Configure.jsp:31
