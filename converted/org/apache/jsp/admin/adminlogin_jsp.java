...
public final class adminlogin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/footer.jsp", Long.valueOf(1774932954924L));
    _jspx_dependants.put("/header.jsp", Long.valueOf(1774932954924L));
  }
...
if(request.getParameter("Login")!=null)  // [JSP] admin/adminlogin.jsp:8
{  // [JSP] admin/adminlogin.jsp:9
     Connection con=new DBConnect().connect(getServletContext().getRealPath("/WEB-INF/config.properties"));  // [JSP] admin/adminlogin.jsp:10
     String user=request.getParameter("username");  // [JSP] admin/adminlogin.jsp:11
     String pass=HashMe.hashMe(request.getParameter("password")); //Hashed Password   // [JSP] admin/adminlogin.jsp:12
     try  // [JSP] admin/adminlogin.jsp:13
             {  // [JSP] admin/adminlogin.jsp:14
                    if(con!=null && !con.isClosed())  // [JSP] admin/adminlogin.jsp:15
                               {  // [JSP] admin/adminlogin.jsp:16
                                   ResultSet rs=null;  // [JSP] admin/adminlogin.jsp:17
                                   Statement stmt = con.createStatement();    // [JSP] admin/adminlogin.jsp:18
                                   rs=stmt.executeQuery("select * from users where username='"+user+"' and password='"+pass+"' and privilege='admin'");  // [JSP] admin/adminlogin.jsp:19
                                   if(rs != null && rs.next()){  // [JSP] admin/adminlogin.jsp:20
                                   session.setAttribute("isLoggedIn", "1");  // [JSP] admin/adminlogin.jsp:21
                                   session.setAttribute("userid", rs.getString("id"));  // [JSP] admin/adminlogin.jsp:22
                                   session.setAttribute("user", rs.getString("username"));  // [JSP] admin/adminlogin.jsp:23
                                   session.setAttribute("avatar", rs.getString("avatar"));  // [JSP] admin/adminlogin.jsp:24
                                   session.setAttribute("privilege", rs.getString("privilege"));  // [JSP] admin/adminlogin.jsp:25
                                   
                                   Cookie privilege=new Cookie("privilege","admin");  // [JSP] admin/adminlogin.jsp:27
                                    privilege.setPath(request.getContextPath());  // [JSP] admin/adminlogin.jsp:28
                                   response.addCookie(privilege);  // [JSP] admin/adminlogin.jsp:29
                                   
                                   response.sendRedirect("admin.jsp");  // [JSP] admin/adminlogin.jsp:31
                                   }  // [JSP] admin/adminlogin.jsp:32
                                   else  // [JSP] admin/adminlogin.jsp:33
                                   {  // [JSP] admin/adminlogin.jsp:34
                                	   response.sendRedirect("adminlogin.jsp?err=<span style='color:red'>Username/Password is wrong</span>");  // [JSP] admin/adminlogin.jsp:35
                                   }  // [JSP] admin/adminlogin.jsp:36
                                    
                               }  // [JSP] admin/adminlogin.jsp:38
                }  // [JSP] admin/adminlogin.jsp:39
               catch(SQLException ex)  // [JSP] admin/adminlogin.jsp:40
                {  // [JSP] admin/adminlogin.jsp:41
                         response.sendRedirect("adminlogin.jsp?err=<span style='color:red'>Something went wrong</span>");  // [JSP] admin/adminlogin.jsp:42
                
                }  // [JSP] admin/adminlogin.jsp:44
			     catch(Exception e)  // [JSP] admin/adminlogin.jsp:45
			     {  // [JSP] admin/adminlogin.jsp:46
			    	 response.sendRedirect("adminlogin.jsp?err="+e);			  // [JSP] admin/adminlogin.jsp:47
			     }  // [JSP] admin/adminlogin.jsp:48
}  // [JSP] admin/adminlogin.jsp:49
 ...
 if(request.getParameter("err")!=null){out.print(request.getParameter("err"));}   // [JSP] admin/adminlogin.jsp:58
      out.write("</td></tr>\n</table>  \n</form>\n\n ");
