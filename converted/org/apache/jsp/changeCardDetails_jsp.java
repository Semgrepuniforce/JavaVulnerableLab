 ...
 Connection con=new DBConnect().connect(getServletContext().getRealPath("/WEB-INF/config.properties"));
   ...
   try
   {
    ...
    if(action!=null && action.equalsIgnoreCase("add") )
    {
        ...
        {
         Statement stmt = con.createStatement();  // [JSP] changeCardDetails.jsp:42
         stmt.executeUpdate("INSERT into cards(id,cardno, cvv,expirydate) values ('"+id+"','"+cardno+"','"+cvv+"','"+expirydate+"')");  // [JSP] changeCardDetails.jsp:43
         out.print("<b style='color:green'> * Card details added *</b>");     // [JSP] changeCardDetails.jsp:44
        }  // [JSP] changeCardDetails.jsp:45
        else  // [JSP] changeCardDetails.jsp:46
        {  // [JSP] changeCardDetails.jsp:47
            out.print("<b style='color:red'>*  Please Fill all the details * </b>");  // [JSP] changeCardDetails.jsp:48
        }  // [JSP] changeCardDetails.jsp:49
    }  // [JSP] changeCardDetails.jsp:50

     out.print("<br/><br/><a href='"+path+"/myprofile.jsp?id="+id+"'>Return to Profile Page &gt;&gt;</a>");   // [JSP] changeCardDetails.jsp:52

    }  // [JSP] changeCardDetails.jsp:54
   catch(Exception e)  // [JSP] changeCardDetails.jsp:55
   {  // [JSP] changeCardDetails.jsp:56
       out.print(e);  // [JSP] changeCardDetails.jsp:57
   }  // [JSP] changeCardDetails.jsp:58
}  // [JSP] changeCardDetails.jsp:59
else  // [JSP] changeCardDetails.jsp:60
{  // [JSP] changeCardDetails.jsp:61
    out.print("Please login to view this page");  // [JSP] changeCardDetails.jsp:62
}  // [JSP] changeCardDetails.jsp:63
