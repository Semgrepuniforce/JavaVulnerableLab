...
if(request.getParameter("secret")!=null)
             {
                 Connection con=new DBConnect().connect(getServletContext().getRealPath("/WEB-INF/config.properties"));  // [JSP] ForgotPassword.jsp:39
                  ResultSet rs=null;  // [JSP] ForgotPassword.jsp:40
                  Statement stmt = con.createStatement();    // [JSP] ForgotPassword.jsp:41
                  rs=stmt.executeQuery("select * from users where username='"+request.getParameter("username").trim()+"' and secret='"+request.getParameter("secret")+"'");  // [JSP] ForgotPassword.jsp:42
                  if(rs != null && rs.next()){  // [JSP] ForgotPassword.jsp:43
                      out.print("Hello "+rs.getString("username")+", <b class='success'> Your Password is: "+rs.getString("password"));  // [JSP] ForgotPassword.jsp:44
                  }  // [JSP] ForgotPassword.jsp:45
                  else  // [JSP] ForgotPassword.jsp:46
                  {  // [JSP] ForgotPassword.jsp:47
                      out.print("<b class='fail'> Secret/Email is wrong</b>");  // [JSP] ForgotPassword.jsp:48
                  }  // [JSP] ForgotPassword.jsp:49
             }  // [JSP] ForgotPassword.jsp:50
