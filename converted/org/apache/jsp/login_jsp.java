...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String username="";  // [JSP] login.jsp:5
 String password="";  // [JSP] login.jsp:6
 Cookie[] cookies = request.getCookies();  // [JSP] login.jsp:7
 if (cookies != null)  // [JSP] login.jsp:8
  for (Cookie c : cookies) {  // [JSP] login.jsp:9
        if ("username".equals(c.getName())) {  // [JSP] login.jsp:10
         username= c.getValue();  // [JSP] login.jsp:11
        }  // [JSP] login.jsp:12
        else if("password".equals(c.getName()))  // [JSP] login.jsp:13
        {  // [JSP] login.jsp:14
            password= c.getValue();  // [JSP] login.jsp:15
        }  // [JSP] login.jsp:16
  }  // [JSP] login.jsp:17
 ...
 if(request.getParameter("err")!=null){out.print(request.getParameter("err"));}   // [JSP] login.jsp:26
