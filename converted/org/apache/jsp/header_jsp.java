...
public final class header_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
   ...
   String path = request.getContextPath();  // [JSP] header.jsp:5
   String configPath=getServletContext().getRealPath("/WEB-INF/config.properties");  // [JSP] header.jsp:6
   
    Properties properties=new Properties();  // [JSP] header.jsp:8
    properties.load(new FileInputStream(configPath));  // [JSP] header.jsp:9
    String siteTitle=properties.getProperty("siteTitle");  // [JSP] header.jsp:10
 ...
 out.print("<script src=\""+path+"/jquery.min.js\" type=\"text/javascript\"></script>");   // [JSP] header.jsp:18
